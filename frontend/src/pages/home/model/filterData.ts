...
export const dataFilter = (t: TFunction) => {
    ...
    const dataYear = [
        ...
        { id: "Before 1990", htmlFor: "Before 1990", label: t("Before", { year: 1990 }), value: "before-1990" },
        ...
        { id: "2020-Today", htmlFor: "2020-Today", label: t("Today", { year: 2020 }), value: "2020-today" },
    ];
