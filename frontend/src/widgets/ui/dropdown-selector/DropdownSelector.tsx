...
export const DropdownSelector: React.FC<DropdownSelectorProps> = ({ label, options, isOpen, onToggle }) => {
    ...
    return (
        <div className={ styles.formGroup } ref={ dropdownRef }>
            ...
            <Button variant="btnDropdownToggle" onClick={ onToggle }>--Select--</Button>
